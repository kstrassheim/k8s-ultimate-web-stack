...
// rather than prompting for the one scope that is missing (issue #141).
...
// module graph, so a GraphConsentRequiredError can cross a module boundary
// that `instanceof` does not survive.
 ...
 *   that window is a separate Edge browser window outside the app (#141).
 */
