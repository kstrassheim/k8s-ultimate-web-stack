/**
 * Regression coverage for issue #141 — the MSAL popup redirect bridge.
 *
...
// main.jsx reads `basePath` to set the router basename; this repo serves the
// app at a domain root AND under an nginx subpath, so pin it for the test.
jest.mock('@/config', () => ({ __esModule: true, basePath: '/', frontendUrl: 'http://localhost' }));
...
describe('main.jsx auth redirect frame detection (issue #141)', () => {
  beforeEach(() => {
